...
import { useUploadIncentiveRatesMutation } from '../../store/apiSlice'
...
export default function UploadIncentiveRates() {
  const [upload] = useUploadIncentiveRatesMutation()
    ...
    <div className="font-[Inter]">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Upload a CSV file with incentive rate data. Records are stored in{' '}
          <code className="text-xs">ins_incentive_rates</code> and used by the
          incentive calculation engine for NB and renewal commission lookups.
        </p>
      </div>
      ...
      <div className="mb-6">
        <p className="text-xs text-gray-400">
          CSV must include: product_code, channel_code, policy_year,
          transaction_type, rate_type, incentive_rate, min_premium_slab,
          max_premium_slab, min_policy_term, max_policy_term, effective_from,
          effective_to
        </p>
      </div>
      ...
      <div className="mb-6 flex items-center gap-3">
        {!uploadDone ? (
          ...
          >
            {isUploading ? 'Uploading…' : 'Upload Incentive Rates'}
          </button>
        ) : (
          <>
            <span className="text-sm font-medium text-green-600">
              ✓ {uploadCount} rate(s) uploaded
            </span>
            <button
              type="button"
              onClick={handleReset}
      ...
      {uploadDone && productCodes.length > 0 && (
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          ...
          <p className="mt-3 text-xs text-gray-400">
            Incentive rates are now available for NB and renewal commission
            lookups in the calculation engine.
          </p>
        </div>
      )}
    </div>
