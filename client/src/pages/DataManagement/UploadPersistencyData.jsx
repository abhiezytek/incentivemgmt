...
import { useUploadPersistencyDataMutation } from '../../store/apiSlice'
...
export default function UploadPersistencyData() {
  const [upload] = useUploadPersistencyDataMutation()
    ...
    <div className="font-[Inter]">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Upload a CSV file with persistency data. Records are stored in{' '}
          <code className="text-xs">ins_persistency_data</code> and used by the
          incentive calculation engine for persistency gate checks.
        </p>
      </div>
      ...
      <div className="mb-6">
        <p className="text-xs text-gray-400">
          CSV must include: agent_code, persistency_month, period_start,
      ...
      <div className="mb-6 flex items-center gap-3">
        {!uploadDone ? (
          ...
          >
            {isUploading ? 'Uploading…' : 'Upload Persistency Data'}
          </button>
        ) : (
          <>
            <span className="text-sm font-medium text-green-600">
              ✓ {uploadCount} record(s) uploaded
            </span>
            <button
              type="button"
              onClick={handleReset}
      ...
      {uploadDone && agentCodes.length > 0 && (
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          ...
          <p className="mt-3 text-xs text-gray-400">
            Persistency data is now available for incentive calculation
            persistency gate checks.
          </p>
        </div>
      )}
    </div>
